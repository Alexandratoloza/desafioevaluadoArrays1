...
//listas del primero y ultimo paciente
...
const newArray = UserTraumatologia.filter((fonasa) => {
  if(paciente.fonasa){
    return fonasa
  }
})

document.write(`<p> Pacientes Fonasa: ${UserTraumatologia[2].paciente} - ${UserTraumatologia[4].prevision}<p/>`)
UserTraumatologia.textContent = `Traumatologia Pacientes Fonasa ${UserTraumatologia[4].prevision}`
